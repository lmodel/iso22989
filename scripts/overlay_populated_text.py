#!/usr/bin/env python3
"""Deep-merge an overlay schema onto the public iso22989 schema.
...
Usage:
    uv run python scripts/overlay_populated_text.py \
        ...
        --overlay src/iso22989/schema/iso22989-overlay.yaml \
        --output  tmp/iso22989-merged.yaml
"""
...
def main() -> int:
    ...
    if not args.overlay.exists():
        raise SystemExit(
            ...
            "Copy iso22989-overlay.template.yaml to iso22989-overlay.yaml and "
            "populate placeholders from your licensed ISO/IEC 22989:2022 copy."
        )
    ...
    with args.output.open("w", encoding="utf-8") as fh:
        fh.write(
            "# AUTO-GENERATED merged schema. Contains verbatim ISO/IEC 22989:2022\n"
